...
```sh
git clone git@github.com:zlh20040308/zlh-chisel-template.git
cd zlh-chisel-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting zlh-chisel-template'
